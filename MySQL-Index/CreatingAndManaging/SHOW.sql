...
-- null
-- YES if the column contains NULL values and blank if it does not.
...
-- expression
-- If the index uses an expression rather than a column or column prefix value, the expression indicates the expression for the key part and also the column_name column is NULL.
