...
if (CRYPT_STD_DES == 1)
{
echo "Standard DES: ".crypt($str,'st')."\n<br>";
}
else
{
...
if (CRYPT_EXT_DES == 1)
{
echo "Extended DES: ".crypt($str,'_S4..some')."\n<br>";
}
else
{
...
if (CRYPT_BLOWFISH == 1)
{
echo "Blowfish: ".crypt($str,'$2a$09$anexamplestringforsalt$')."\n<br>";
}
else
{
...
if (CRYPT_SHA256 == 1)
{
echo "SHA-256: ".crypt($str,'$5$rounds=5000$anexamplestringforsalt$')."\n<br>"; }
else
{
...
if (CRYPT_SHA512 == 1)
{
echo "SHA-512: ".crypt($str,'$6$rounds=5000$anexamplestringforsalt$');
}
else
{
