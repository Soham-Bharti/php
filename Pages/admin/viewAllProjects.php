            ...
            <table id="projectsTable" class="table table-striped table-hover">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="showProjectMembers.php?id=<?php echo $row["id"] ?>" class="btn btn-success text-white btn-sm">Show Members</a>
                            </td>
                            <td>
                                <a href="addProjectMember.php?id=<?php echo $row["id"] ?>" class="btn btn-warning text-muted btn-sm">Add Member</a>
                            </td>
                        </tr>
                <?php
                    }
